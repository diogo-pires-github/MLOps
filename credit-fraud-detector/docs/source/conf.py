...
# credit_fraud_detector documentation build
...
from credit_fraud_detector import __version__ as release

# -- Project information -----------------------------------------------------

project = "credit_fraud_detector"
author = "Kedro"
...
htmlhelp_basename = "credit_fraud_detectordoc"
...
latex_documents = [
    (
        master_doc,
        "credit_fraud_detector.tex",
        "credit_fraud_detector Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "credit_fraud_detector",
        "Project credit_fraud_detector codebase.",
        "Data-Science",
    )
]
